...
import type { RouteWeather } from "@gis/shared";
        ...
        {routes.map(
          (route) =>
            route.alerts.length > 0 && (
              <div
                key={route.vehicle}
                className="p-3 border-b border-border/10 last:border-0"
              >
                <div className="flex items-center justify-between mb-3 px-1">
                  ...
                  <div
                    className={`flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-extrabold uppercase ${
                ...
                <div className="space-y-2">
                  {route.alerts.map((alert, idx) => (
                    <div
                      ...
                      className={`group relative flex items-start gap-3 p-3 rounded-xl border transition-all hover:translate-x-0.5 ${
                        alert.severity === "HIGH"
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center justify-between mb-0.5">
                          ...
                          <span className="text-[10px] font-medium text-muted-foreground">
                            {new Date(alert.timeWindow).toLocaleTimeString([], {
                              hour: "2-digit",
                              minute: "2-digit",
                            })}
                          </span>
