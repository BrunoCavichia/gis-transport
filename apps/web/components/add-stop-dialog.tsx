...
import { MapPin, Target, Loader2, ChevronRight, ChevronLeft, Map as MapIcon, RefreshCw, Route } from "lucide-react";
    ...
    <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
        ...
        <div className="relative">
            ...
            <div className="relative flex justify-center text-[10px] uppercase tracking-widest font-black">
                <span className="bg-background px-3 text-muted-foreground/50">O precisión por coordenadas</span>
            </div>
        </div>

        <div className="grid grid-cols-2 gap-4">
            <div className="space-y-1.5">
                <Label className="text-[10px] font-bold uppercase text-muted-foreground/70 ml-1">Latitud</Label>
                <Input
                    value={latitude}
            ...
            <div className="space-y-1.5">
                <Label className="text-[10px] font-bold uppercase text-muted-foreground/70 ml-1">Longitud</Label>
                <Input
                    value={longitude}
    ...
    <div className="space-y-6 animate-in fade-in zoom-in duration-300">
        ...
        <div className="p-4 rounded-xl bg-primary/5 border border-primary/10 flex items-center gap-4">
            ...
            <div className="space-y-1">
                <p className="text-[10px] font-black uppercase tracking-widest text-muted-foreground/50 leading-none">Confirmar Coordenadas</p>
...
const Step3Content = memo(({
    ...
    <div className="space-y-6 animate-in fade-in slide-in-from-left-4 duration-300">
        <div className="space-y-2">
            <Label htmlFor="stop-label" className="text-sm font-semibold">Nombre de la Parada</Label>
            <Input
                id="stop-label"
        ...
        <div className="p-4 rounded-xl bg-muted/30 border border-border/50 flex items-center gap-4 opacity-70">
            ...
            <div className="space-y-1">
                <p className="text-[10px] font-black uppercase tracking-widest text-muted-foreground/50 leading-none">Ubicación Fijada</p>
                <p className="text-xs font-mono font-bold text-foreground/80">
                    {latitude}, {longitude}
                </p>
            </div>
                ...
                <div className="bg-gradient-to-br from-primary/10 via-background to-background p-6">
                    <DialogHeader className="mb-6">
                        <div className="flex items-center gap-3 mb-1">
                            ...
                            <div>
                                <DialogTitle className="text-xl font-bold tracking-tight">Añadir Parada Manual</DialogTitle>
                        ...
                        <p className="text-[11px] text-muted-foreground font-medium leading-relaxed mt-1">
                            Asignando parada a: <span className="text-foreground font-bold">{vehicleLabel}</span>
                        </p>
                    </DialogHeader>
