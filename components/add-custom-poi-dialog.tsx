...
interface AddCustomPOIDialogProps {
  ...
  onSubmit: (label: string, coords: [number, number], description?: string) => void;
  onStartPicking?: () => void;
...
const Step3Content = memo(({
  ...
  <div className="space-y-6 animate-in fade-in slide-in-from-left-4 duration-300">
    <div className="space-y-4">
      <div className="space-y-2">
        <Label htmlFor="poi-label" className="text-sm font-semibold">POI Reference Name</Label>
        <Input
          id="poi-label"
      ...
      <div className="space-y-2">
        <Label htmlFor="poi-desc" className="text-sm font-semibold">Description (Optional)</Label>
        <Input
          id="poi-desc"
