...
const SelectContent = React.memo(function SelectContent({
  ...
  const handleFocusCapture = React.useCallback(
    (e: React.FocusEvent) => onFocusCapture?.(e),
    [onFocusCapture],
  );
  const handleBlurCapture = React.useCallback(
    (e: React.FocusEvent) => onBlurCapture?.(e),
    [onBlurCapture],
  );
  const handlePointerDownCapture = React.useCallback(
    (e: React.PointerEvent) => onPointerDownCapture?.(e),
    [onPointerDownCapture],
  );
...
const SelectLabel = React.memo(function SelectLabel({
  ...
  const labelClassName = React.useMemo(
    () => cn("text-muted-foreground px-2 py-1.5 text-xs", className),
    [className],
  );
...
const SelectItem = React.memo(function SelectItem({
  ...
  return (
    ...
    >
      ...
      <SelectPrimitive.ItemText>{memoChildren}</SelectPrimitive.ItemText>
    </SelectPrimitive.Item>
  );
});
...
const SelectSeparator = React.memo(function SelectSeparator({
  ...
  const sepClassName = React.useMemo(
    () => cn("bg-border pointer-events-none -mx-1 my-1 h-px", className),
    [className],
  );
